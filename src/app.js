                ...
                <tbody>
                  ${calculatedIngredients.map((ingredient, index) => `
                    <tr>
                      ...
                      <td><input class="unit-input" aria-label="${ingredient.name || "regel"} eenheid" data-ingredient-index="${index}" data-kind="unit" type="text" value="${escapeHtml(ingredient.unit || "")}" placeholder="g" /></td>
                    </tr>
                  `).join("")}
                </tbody>
              </table>
